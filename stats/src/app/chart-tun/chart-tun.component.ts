...
export class ApiStat {
  ...
  getReport(annee:any): Observable<any> {
    ...
    return this.http.post(this.baseurl + '/report-tun/', formData, { headers: header })
  }
}
@Component({
  selector: 'app-chart-tun',
  templateUrl: './chart-tun.component.html',
  styleUrls: ['./chart-tun.component.css'],
  providers: [ApiStat]
})
export class ChartTunComponent implements OnInit {
