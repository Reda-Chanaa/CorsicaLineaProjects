...
export class ApiStat {
  ...
  sendFile(File1: any, annee1: any, annee2: any): Observable<any> {
    ...
    return this.http.post(this.baseurl + '/conco-tun/', formData, { headers: header })
  }
}
...
@Component({
  selector: 'app-conco-tun',
  templateUrl: './conco-tun.component.html',
  styleUrls: ['./conco-tun.component.css'],
  providers: [ApiStat]
})
export class ConcoTunComponent {

  day = new Date().getDate()
  mois = new Date().getMonth() + 1
  annees = new Date().getFullYear()
  date = "ConcordanceTUN_" + this.day + "-" + this.mois + "-" + this.annees
