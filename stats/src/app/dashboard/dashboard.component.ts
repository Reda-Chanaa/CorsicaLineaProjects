...
export class ApiStat implements OnInit {
  ...
  constructor(private http: HttpClient) {
    this.getReport(this.annee).subscribe(
      data => {
        this.dataAll = data;
        console.log(data)
      },
  ...
  async ngOnInit(){
    await this.getReport(this.annee).subscribe(
      data => {
        this.dataAll = data;
        console.log(data)
      },
...
@Component({
  ...
  providers: [ApiStat,{provide: APP_INITIALIZER, useFactory: loadConfig, deps: [ApiStat], multi: true}]
})
export class DashboardComponent {
  ...
  constructor(private DATACLEANING: ApiStat) {
    this.dataAll=this.DATACLEANING.dataAll
  ...
  async ngOnInit() {
    ...
    this.lineChartGradientsNumbersLabels = ["Janvier", "Février", "Mars", "Avril", "Mai", "Juin", "Juillet", "Août", "Septembre", "Octobre", "Novembre", "Decembre"];
  ...
  async getReport(){
    await this.DATACLEANING.getReport(this.annee).subscribe(
      data => {
        this.dataAll = data;
        console.log(data[0])
      },
