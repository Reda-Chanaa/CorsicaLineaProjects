...
export class ApiStat {
  ...
  sendFile(File1: any, File2: any, annee: any, mois: any): Observable<any> {
    ...
    return this.http.post(this.baseurl + '/stat-tun-cl/', formData, { headers: header })
  }
}
...
@Component({
  selector: 'app-stat-tun-cl',
  templateUrl: './stat-tun-cl.component.html',
  styleUrls: ['./stat-tun-cl.component.css'],
  providers: [ApiStat]
})
export class StatTunClComponent {
  ...
  displayedColumns: string[] = ['TUNISIE', 'VENTEYES', 'VENTE', 'CUMULE', 'ECART'];
