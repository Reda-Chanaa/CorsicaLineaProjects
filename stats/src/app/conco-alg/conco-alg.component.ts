...
export class ApiStat {
  ...
  sendFile(File1: any, annee1: any, annee2: any): Observable<any> {
    ...
    return this.http.post(this.baseurl + '/conco-alg/', formData, { headers: header })
  }
}
...
@Component({
  selector: 'app-conco-alg',
  templateUrl: './conco-alg.component.html',
  styleUrls: ['./conco-alg.component.css'],
  providers: [ApiStat]
})
export class ConcoAlgComponent {

  day = new Date().getDate()
  mois = new Date().getMonth() + 1
  annees = new Date().getFullYear()
  date = "ConcordanceALG_" + this.day + "-" + this.mois + "-" + this.annees
